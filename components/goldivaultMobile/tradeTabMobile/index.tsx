    ...
    <div className="relative w-[100%] h-[100%] flex flex-col">
      ...
      <div className="w-[100%] h-[50%] border-t-2 border-[#FFCD00]">
        <div className="mx-auto w-[95%] h-[100%] py-[3.5%] relative">
          <h1 className="text-[4vw] text-white font-baloo font-medium mt-[2.5%]">Estimated tokens received</h1>
          <div className="h-[50%] w-[100%] mt-[5%] flex flex-row items-center justify-between border-2 border-black bg-slate-200 pr-[1%] pl-[3.5%]">
