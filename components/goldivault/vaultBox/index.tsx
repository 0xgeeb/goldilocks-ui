                ...
                </div>
                {
                  ...
                  <div className="w-[100%] h-[50%] flex flex-row items-center justify-between">
                    <div className="h-[100%] w-[42.5%] flex flex-row items-center justify-around">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-[1.5vw] lg:text-[1vw] text-white font-baloo font-medium mt-[5%]">Honey: {outputTokensLoading ? loadingElement() : redeemYTAmounts.honey > 0 ? redeemYTAmounts.honey.toFixed(4) : redeemYTAmounts.honey}</span>
                      </div>
                    </div>
                  ...
                  <div className="w-[100%] h-[50%] flex flex-row items-center justify-between">
                    <div className="h-[100%] w-[47.5%] flex flex-row items-center justify-between border-2 border-black bg-slate-200 px-[3.5%]">
                      ...
                      <span className={`font-baloo text-nowrap font-bold ${activeToggle === 'REDEEMOT' ? "text-[2vw] lg:text-[1vw]" : "text-[2.25vw] lg:text-[1.25vw]"}`}>{activeToggle === 'DEPOSIT' ? "OT" : params.dt}</span>
                    </div>
                    <div className={`h-[100%] w-[47.5%] flex flex-row items-center justify-between border-2 border-black ${activeToggle === 'REDEEMOT' ? "bg-red-400" : "bg-slate-200"} px-[3.5%]`}>
                      <span className="font-baloo text-nowrap font-bold text-[3vw] lg:text-[1.25vw]">{outputTokensLoading ? loadingElement() : formatBalance(ytAmount)}</span>
