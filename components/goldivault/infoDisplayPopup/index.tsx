...
export const InfoDisplayPopup = () => {
  ...
  return (
    <div className="absolute right-[2%] top-[-2%] z-50 h-[16%] w-[60%] xl:w-[50%]">
      <div className="relative h-[100%] w-[100%] border-2 border-[#FFCD00] bg-[#9A5816] px-2 text-center font-baloo text-[1.5vw] font-semibold xl:text-[1.25vw] 2xl:text-[1vw]">
        ...
        <div className="absolute inset-2 flex flex-col items-center justify-center border-2 border-[#FFCD00] bg-[#C8894A]">
          ...
          <span className="mx-auto w-[80%] border-b-2 border-[#FFCD00]"></span>
          <span>{texts[1]}</span>
        </div>
      </div>
    </div>
