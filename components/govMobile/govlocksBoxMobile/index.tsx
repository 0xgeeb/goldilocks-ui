...
export const GovLocksBoxMobile = () => {
  ...
  return (
    <div className="absolute top-[12.5%] left-[2.5%] w-[95%] h-[65%] border-2 border-black bg-[#EEDCD2]">
      ...
      <div className="absolute inset-4 border-2 border-black bg-[#D9C6BA]">
        <div className="w-[100%] h-[100%] flex flex-col py-[5%]">
          <div className="w-[95%] flex flex-row justify-between items-center mx-auto font-amaticbold font-medium text-[7vw]">
            <h1 className={`${govlocksActiveToggle === 'WRAP' ? "underline" : ""}`} onClick={() => changeGovlocksActiveToggle('WRAP')}>WRAP</h1>
            <h1 className={`${govlocksActiveToggle === 'UNWRAP' ? "underline" : ""}`} onClick={() => changeGovlocksActiveToggle('UNWRAP')}>UNWRAP</h1>
            <h1 className={`${govlocksActiveToggle === 'DELEGATE' ? "underline" : ""}`} onClick={() => changeGovlocksActiveToggle('DELEGATE')}>DELEGATE</h1>
          </div>
          <div className="h-[30%] w-[90%] mx-auto border-2 border-black bg-white my-[15%]">
            <div className="relative h-[100%] w-[100%]">
              {
                govlocksActiveToggle === "DELEGATE" ?
                <input
                  className="absolute top-[15%] pl-[5%] w-[90%] focus:outline-none border-none bg-transparent font-bold font-baloo text-[7vw]"
                  type="string"
                  placeholder=""
              ...
              <span className="absolute bottom-0 right-[3%] font-baloo font-bold text-[5vw] text-[#7F7F7F]" onClick={() => handleGovlocksBalanceClick()}>
          ...
          {
            govlocksAllowanceButtons &&
            <div className="flex flex-row items-center justify-between mx-auto w-[90%] h-[12.5%]">
              <button
                className="bg-[#E7B941] h-[100%] w-[46%] border-2 border-black font-amaticbold text-[6vw]"
          ...
          }
          {
            ...
            <ConnectButton.Custom>
              {({
                ...
                return (
                  <button
                    className={`mx-auto h-[12.5%] w-[36%] ${buttonLoadingColor ? "bg-[#B35227] text-[#E7B941]" : "bg-[#E7B941] text-black"} font-amaticbold text-[7vw] border-2 border-black`}
                    id="govlocks-button"
                    onClick={() => {
                      const button = document.getElementById('govlocks-button')
