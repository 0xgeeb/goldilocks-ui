    ...
    <main className="flex flex-col min-h-screen overflow-hidden">
      ...
      <div className="w-[100vw] bg-black flex flex-col items-center relative">
        <div className="h-[65vh] w-[100%] flex flex-col items-center justify-between font-amatic my-[5%]">
          <h1 className="text-[7vw] font-amaticbold text-[#FFCD00]">"Show me the honey"</h1>
          <div className="flex flex-row items-center justify-center w-[100%]">
            <h2 className="text-[#FFCD00] text-[2vw]">Henlo, welcome to </h2>
            <h2 className="text-[#FFCD00] text-[3vw] mx-[1%] font-amaticbold">GOLDILOCKS.</h2>
            <h2 className="text-[#FFCD00] text-[2vw]"> novel defi infrastructure on berachain</h2>
            </div>
          <h2 className="text-[#FFCD00] text-[2vw]">check out our three products</h2>
          <img className="w-[2%] animate-bounce" src="/images/icon-arrows.png" alt="arrows" />
        </div>
        <div className="w-[85vw] flex flex-row items-center justify-between text-[#FFCD00] font-amatic my-[5%]">
          <h1 className="text-[6vw] font-amaticbold mb-[6%]">GOLDISWAP</h1>
          <div className="flex flex-col items-center w-[50%]">
            <img className="w-[100%] mb-[3%]" src="/images/bg-goldiswap-home.png" alt="goldiswap" />
            <div className="flex flex-row items-center justify-center w-[100%]">
              <h2 className="text-[#FFCD00] text-[1.7vw]">This one is called </h2>
              <h2 className="text-[#FFCD00] text-[3vw] mx-[2%] font-amaticbold">GOLDISWAP.</h2>
              <h2 className="text-[#FFCD00] text-[1.7vw]"> where beras exchange their sweet honeys</h2>
            </div>
          </div>
        ...
        <div className="w-[85vw] flex flex-row items-center justify-between text-[#FFCD00] font-amatic my-[5%]">
          ...
          <div className="flex flex-col items-center w-[50%]">
            ...
            <div className="flex flex-row items-center justify-center w-[100%]">
              <h2 className="text-[#FFCD00] text-[1.7vw]">This is </h2>
              <h2 className="text-[#FFCD00] text-[3vw] mx-[2%] font-amaticbold">GOLDILEND.</h2>
              <h2 className="text-[#FFCD00] text-[1.7vw]"> where beras borrow against their sweet assets</h2>
            </div>
          </div>
        ...
        <div className="w-[85vw] flex flex-row items-center justify-between text-[#FFCD00] font-amatic my-[5%]">
          ...
          <div className="flex flex-col items-center w-[50%]">
            ...
            <div className="flex flex-row items-center justify-center w-[100%]">
              <h2 className="text-[#FFCD00] text-[1.7vw]">And this is </h2>
              <h2 className="text-[#FFCD00] text-[3vw] mx-[2%] font-amaticbold">GOLDIVAULTS.</h2>
              <h2 className="text-[#FFCD00] text-[1.7vw]">where beras split their tokens</h2>
            </div>
          </div>
