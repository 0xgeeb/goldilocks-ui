  ...
  return (
    ...
    <main className="w-screen h-screen" onClick={() => handlePopups()}>
      ...
      <div className="w-[100%] h-[89%] lg:h-[85%] bg-cover bg-bottom bg-[url('/images/bg-goldiswap.png')] relative">
        ...
        <h1 className="absolute top-[16%] lg:top-[12.16%] right-[81%] lg:right-[75%] text-[#D9C6BA] text-[8vw] font-amaticbold" id="page-title">{activeToggle}</h1>
        <div className="absolute top-[13.22%] lg:top-[9.387%] left-[20%] lg:left-[28.125%] w-[60%] lg:w-[43.75%] h-[2.78%] bg-[#634C43] flex flex-row items-center justify-between px-2 text-[1.5vw] lg:text-[0.85vw]">
        ...
        <WalletBalance />
        <BorrowBox />
        <img className="absolute top-[49.87%] lg:top-[46.04%] left-[88%] lg:left-[75.5%] w-[4%] h-[2%] lg:w-[3%]" src="/images/icon-bearoutline.png" alt="bearoutline" />
        <div 
          className="absolute w-[10%] h-[7%] lg:w-[6%] lg:h-[8%] top-[51.87%] lg:top-[48.04%] left-[85%] lg:left-[74%] border-2 border-black bg-[#F3AA8A] flex items-center justify-center font-amaticbold text-[2vw] lg:text-[1.2vw] hover:scale-110 cursor-pointer"
