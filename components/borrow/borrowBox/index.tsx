          ...
          <div className="w-[100%] h-[100%] relative flex flex-col">
            ...
            <div className="absolute h-[32%] w-[55.6%] top-[30%] left-[22%] border-2 border-black bg-white">
              <div className="relative h-[100%] w-[100%]">
                ...
                />
                <span className="absolute bottom-0 right-[3%] font-baloo font-bold text-[0.9vw] text-[#7F7F7F]">{activeToggle === "BORROW" ? "borrow limit" : "borrowed honey"}: {balancesLoading ? loadingElement() : handleBalance()}</span>
              </div>
            </div>
          </div>
        }
