...
export const WalletBalanceMobilePopup = () => {
  ...
  return (
    <div className="relative flex size-full flex-col items-center bg-[#D5A774] px-[8%] font-baloo text-[2.7vw] font-semibold">
      <h1 className="mb-[2%] ml-[5%] mt-[12%] font-amaticbold text-[10vw]">
        THIS IS WALLET BALANCE
      </h1>
      <div className="flex h-[58%] w-full flex-col justify-around">
