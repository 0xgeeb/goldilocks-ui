...
export const SlippagePopup = () => {
  ...
  return (
    <div className="bg-[#B95500] border-2 border-black absolute top-[21.9%] left-[45%] w-[19%] h-[22%] z-20">
      <div className="h-[100%] w-[100%] relative flex flex-col items-center font-baloo font-semibold">
        <span className="text-white text-[1.15vw] mt-[8%]">Set Slippage:</span>
        <div className="relative bg-white w-[60%] h-[50%] border-2 border-black">
          <input
            className="absolute text-[1.4vw] top-[2%] left-[10%] w-[100%] h-[50%] focus:outline-none bg-transparent"
            type="number"
            id="number-input"
          ...
          <div className="absolute bottom-0 w-[100%] h-[50%] bg-[#DCC2A8] border-t-2 border-black flex flex-row">
            ...
            >
              <span className="font-baloo text-[0.8vw]">DEFAULT</span>
            </div>
            <div
            ...
            >
              <span className="font-baloo text-[0.8vw]">CUSTOM</span>
            </div>
          </div>
          <span className="absolute text-[1vw] top-[10%] right-[10%]">%</span>
        </div>
        <p
          className="absolute top-0 right-[4%] font-baloo text-[1.5vw] cursor-pointer hover:scale-110"
