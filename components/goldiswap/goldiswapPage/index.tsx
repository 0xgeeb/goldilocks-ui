  ...
  return (
    ...
    <main className="w-screen h-screen" onClick={(e) => handlePopups(e)}>
      ...
      <div className="w-[100%] h-[89%] xl:h-[85%] bg-cover bg-bottom bg-[url('/images/bg-goldiswap.png')] relative">
        ...
        <div className="absolute top-[15%] md:top-[13%] lg:top-[12%] xl:top-[9%] left-[10%] md:left-[20%] lg:left-[25%] 2xl:left-[28.125%] w-[80%] md:w-[60%] lg:w-[50%] 2xl:w-[43.75%] h-[3%] bg-[#4D0B24] flex flex-row items-center justify-between px-2 text-[2.25vw] md:text-[1.75vw] lg:text-[1.5vw] xl:text-[0.85vw]">
        ...
        <SwapBox />
        <img className="absolute top-[68%] md:top-[55.87%] lg:top-[53.87%] xl:top-[51.04%] left-[90%] lg:left-[78.625%] 2xl:left-[75.5%] w-[4%] h-[2%] lg:w-[3%]" src="/images/icon-bearoutline.png" alt="bearoutline" />
        <div 
          className="absolute w-[12%] md:w-[10%] h-[7%] lg:w-[6%] lg:h-[8%] top-[70%] md:top-[57.87%] lg:top-[55.87%] xl:top-[53.04%] left-[87%] lg:left-[77.125%] 2xl:left-[74%] px-1 border-2 border-black bg-[#F3AA8A] flex items-center justify-center font-amaticbold text-center text-[3vw] md:text-[2.25vw] lg:text-[1.5vw] xl:text-[1.2vw] hover:scale-110 cursor-pointer"
