...
export const LockTab = () => {
  ...
  return (
    ...
    <div className="relative flex flex-col w-[100%] h-[100%]">
      ...
      <div className="absolute flex flex-row top-[38%] left-[2%] xl:left-[4%] items-center">
        <img className="h-8 w-8" src="/images/logo-gibgt.png" alt="coinlogo" />
        <h1 className="font-baloo font-semibold text-[3vw] xl:text-[1.8vw] ml-3 mt-1">iBGT</h1>
      </div>
      <div className="absolute h-[36%] w-[65%] xl:w-[55.6%] top-[30%] left-[22%] border-2 border-black bg-white">
        <div className="relative h-[100%] w-[100%]">
          ...
          />
          <span className="absolute bottom-0 right-[3%] font-baloo font-bold text-[1.8vw] xl:text-[0.9vw] text-[#7F7F7F]">{lendActiveToggle === "UNSTAKE" ? "staked gibgt" : "balance"}: {balancesLoading ? loadingElement() : handleStakeBalance('LOCK')}</span>
        </div>
      </div>
    </div>
  )
