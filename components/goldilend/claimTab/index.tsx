...
export const ClaimTab = () => {
  ...
  return (
    <div className="absolute left-[20%] top-[14%] z-20 h-[65%] w-[60%] border-2 border-black bg-[#EEDCD2] xl:left-[39%] xl:h-[70%] xl:w-[28%]">
      ...
      <div
        className={`absolute inset-8 ${txConfirming ? "border-l-2 border-r-2 border-black" : "border-2 border-black"} bg-[#D9C6BA]`}
      >
        {txConfirming ? (
          <img
          ...
          <div className="relative flex h-[100%] w-[100%] flex-col items-center font-baloo text-[2vw] font-semibold lg:text-[1.5vw] xl:text-[1vw]">
            ...
            <div className="mt-[2%] flex w-[80%] flex-col justify-between">
            ...
            <ConnectButton.Custom>
              {({ account, chain, openChainModal, openConnectModal }) => {
                return (
                  <button
                    className={`mt-[7%] h-[12%] w-[40%] xl:w-[60%] ${buttonLoadingColor ? "bg-[#C9E3B9] text-black" : "bg-[#E7B941] text-black"} flex items-center justify-center border-2 border-black font-amaticbold text-[4vw] hover:scale-110 hover:bg-[#C9E3B9] hover:text-black xl:text-[1.9vw]`}
                    id="claim-button"
                    onClick={() => {
                      const button = document.getElementById("claim-button");
