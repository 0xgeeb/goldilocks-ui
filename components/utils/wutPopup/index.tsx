...
export const WutPopup = () => {
  ...
  return (
    <div className="absolute top-[11%] xl:top-[15%] left-[21.5%] xl:left-[34%] h-[35%] w-[15%] xl:w-[10%] z-50 bg-[#EEDCD2] border-b-2 border-r-2 border-l-2 border-black flex flex-col items-center justify-around font-amaticbold font-semibold text-center text-[2.75vw] xl:text-[2vw] 2xl:text-[1.5vw]">
      <a 
        href="https://goldilocks.gitbook.io/docs" 
        target="_blank"
        className="w-[100%] h-[20%] cursor-pointer flex items-center justify-center"
