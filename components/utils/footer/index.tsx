  ...
  return (
    <>
      ...
      <div className="absolute bottom-[1%] right-[2%] lg:bottom-[3%] lg:right-[3%] flex flex-row items-center text-[#D9C6BA]">
        <span className="font-amatic text-[2.4vw] lg:text-[1.3vw] mr-3 lg:mr-6">OOGA BOOGA</span>
        ...
        <span className="text-[1.2vw] lg:text-[0.7vw] font-baloo ml-3 lg:ml-6">© 2024 Goldilocks DAO. All rights reserved.</span>
      </div>
    </>
  )
}