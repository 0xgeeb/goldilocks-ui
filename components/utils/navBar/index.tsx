        ...
        <div className="w-[80%] xl:w-[65.2%] h-[100%] flex flex-row items-center justify-between text-[2.8vw] xl:text-[2.2vw]">
          ...
          }
          {
            ...
            <>
              ...
              <a href="/goldivault/vault/0xCfeC57e0a0c8a428E335a4222B1558e30A1F4517" className="hover:scale-[150%] cursor-pointer text-[2.1vw] xl:text-[1.6vw]"><span>bHoney</span></a>
            </> :
            ...
            pathname === '/goldivault/vault/0xCfeC57e0a0c8a428E335a4222B1558e30A1F4517' ?
            <>
              <a href="/goldivault/vaults" className="hover:scale-[150%] cursor-pointer text-[2.1vw] xl:text-[1.6vw]"><span>Vaults</span></a>
              <a href="/goldivault/pools" className="hover:scale-[150%] cursor-pointer text-[2.1vw] xl:text-[1.6vw]"><span>Pools</span></a>
              <a href="/goldivault/vault/0xCfeC57e0a0c8a428E335a4222B1558e30A1F4517" className="hover:scale-[150%] cursor-pointer text-[#DB7200] underline underline-offset-8 text-[2.1vw] xl:text-[1.6vw]"><span>bHoney</span></a>
            </> :
