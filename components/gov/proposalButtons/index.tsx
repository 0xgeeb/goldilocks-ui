...
export const ProposalButtons = ({ number }: ButtonsProps) => {
  ...
  return (
    <div className="absolute top-[2.5%] lg:top-[8%] right-[2.5%] lg:right-[5%] w-[35%] lg:w-[25%] h-[8%] lg:h-[10%] flex flex-row items-center justify-between font-amaticbold font-medium text-[3.25vw] lg:text-[1.5vw]">
      {
        (infoLoading || proposalInfoLoading) ?
        loadingElement() :
        <>
          <div
            className={`h-[100%] w-[30%] border-2 border-black ${proposalInfo.cancel && proposal ? "bg-[#D9C6BA] cursor-pointer hover:scale-110" : "bg-gray-300 opacity-30"} flex items-center justify-center`}
            id="cancel"
          ...
          <div
            className={`h-[100%] w-[30%] border-2 border-black ${proposalInfo.queue ? "bg-[#D9C6BA] cursor-pointer hover:scale-110" : "bg-gray-300 opacity-30"} flex items-center justify-center`}
            id="queue"
          ...
          <div
            className={`h-[100%] w-[30%] border-2 border-black ${proposalInfo.execute ? "bg-[#D9C6BA] cursor-pointer hover:scale-110" : "bg-gray-300 opacity-30"} flex items-center justify-center`}
            id="execute"
