...
export const VoteBox = ({ number }: BoxProps) => {
  ...
  return (
    <div className="absolute right-[1.5%] top-[15%] h-[75%] w-[40%] border-2 border-black bg-[#EEDCD2] lg:right-[5%] lg:top-[20%] lg:h-[65%] lg:w-[35%]">
      ...
      <div className="absolute inset-6 border-2 border-black bg-[#D9C6BA] font-amaticbold text-[4vw] font-medium text-black lg:text-[2vw]">
        {infoLoading || proposalInfoLoading ? (
          ...
          activeVoteScreen ? (
            <div className="flex h-[100%] w-[100%] flex-col items-center justify-center p-0">
              <h1>Your votes</h1>
              <h1>{govWalletInfo.votes}</h1>
              <div className="relative mt-[10%] flex h-[15%] w-[95%] flex-row items-center justify-between text-[2.5vw] lg:text-[1.5vw]">
                <div
              ...
              <h1
                className="absolute left-[4%] top-0 cursor-pointer font-baloo text-[4vw] hover:scale-125 lg:left-[2%] lg:text-[2vw]"
            ...
            <div className="flex h-[100%] w-[100%] flex-col items-center justify-center text-center">
              ...
              <h1>Current Votes:</h1>
              <h1 className="text-[2.25vw] lg:text-[1.5vw]">
                for votes: {proposalInfo.forVotes}
              </h1>
              <h1 className="text-[2.25vw] text-red-600 lg:text-[1.5vw]">
          ...
          <div className="flex h-[100%] w-[100%] flex-col items-center justify-center">
            ...
            <h1>Voting Results:</h1>
            <h1 className="text-[2.25vw] text-green-700 lg:text-[1.5vw]">
              for votes: {proposalInfo.forVotes}
            </h1>
            <h1 className="text-[2.25vw] lg:text-[1.5vw]">
              against votes: {proposalInfo.againstVotes}
