...
export const GovLocksBox = () => {
  ...
  return (
    <div className="absolute right-[10%] top-[12.5%] h-[75%] w-[80%] border-2 border-black bg-[#EEDCD2] lg:right-[5%] lg:top-[7.5%] lg:w-[60%]">
      ...
      <div className="absolute inset-6 border-2 border-black bg-[#D9C6BA]">
        <div className="flex h-[100%] w-[100%] flex-col py-[1.5%]">
          <div className="mx-auto flex w-[90%] flex-row items-center justify-between font-amaticbold text-[4vw] font-medium lg:w-[75%] lg:text-[1.75vw]">
            <h1
              className={`cursor-pointer hover:scale-125 ${govlocksActiveToggle === "WRAP" ? "underline" : ""}`}
              onClick={() => changeGovlocksActiveToggle("WRAP")}
            >
              WRAP
            </h1>
            <h1
              className={`cursor-pointer hover:scale-125 ${govlocksActiveToggle === "UNWRAP" ? "underline" : ""}`}
              onClick={() => changeGovlocksActiveToggle("UNWRAP")}
            >
              UNWRAP
            </h1>
            <h1
              className={`cursor-pointer hover:scale-125 ${govlocksActiveToggle === "DELEGATE" ? "underline" : ""}`}
              onClick={() => changeGovlocksActiveToggle("DELEGATE")}
            >
              DELEGATE
            </h1>
          </div>
          <div className="mx-auto my-[10%] h-[25%] w-[70%] border-2 border-black bg-white lg:my-[5%] lg:h-[30%] lg:w-[60%]">
            <div className="relative h-[100%] w-[100%]">
              {govlocksActiveToggle === "DELEGATE" ? (
                <input
                  className="absolute top-[15%] w-[90%] border-none bg-transparent pl-[5%] font-baloo text-[4vw] font-bold focus:outline-hidden lg:text-[2vw]"
                  type="string"
                  placeholder="0x..."
              ...
              <span
                className={`absolute bottom-0 right-[3%] font-baloo text-[2.25vw] font-bold text-[#7F7F7F] lg:text-[0.9vw] ${govlocksActiveToggle === "DELEGATE" ? "" : "cursor-pointer hover:scale-125"}`}
          ...
          {govlocksAllowanceButtons && (
            <div className="mx-auto flex h-[12.5%] w-[60%] flex-row items-center justify-between lg:w-[50%]">
              <button
                className="h-[100%] w-[46%] border-2 border-black bg-[#E7B941] font-amaticbold text-[3vw] hover:scale-110 hover:bg-[#B35227] hover:text-[#E7B941] lg:w-[48%] lg:text-[1.5vw]"
          ...
          {!govlocksAllowanceButtons && (
            <ConnectButton.Custom>
              {({ account, chain, openChainModal, openConnectModal }) => {
                return (
                  <button
                    className={`mx-auto h-[12.5%] w-[36%] ${buttonLoadingColor ? "bg-[#B35227] text-[#E7B941]" : "bg-[#E7B941] text-black"} border-2 border-black font-amaticbold text-[4vw] hover:scale-110 hover:bg-[#B35227] hover:text-[#E7B941] lg:text-[1.9vw]`}
                    id="govlocks-button"
                    onClick={() => {
                      const button = document.getElementById("govlocks-button");
