  ...
  return (
    ...
    <div className="w-[100%] h-[100%] relative flex flex-col">
      ...
      <img className="h-8 w-8" src="/images/logo-gibgt.png" alt="coinlogo" />
        <h1 className="font-baloo font-semibold text-[8vw] ml-2 lg:ml-3">GiBGT</h1>
      </div>
      ...
      <span className="absolute bottom-[2%] right-[3%] font-baloo font-bold text-[4vw] text-[#7F7F7F]">{lendActiveToggle === "UNSTAKE" ? "staked gibgt" : "balance"}: { balancesLoading ? loadingElement() : handleStakeBalance('UNSTAKE') }</span>
    </div>
  )
}