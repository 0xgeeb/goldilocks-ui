...
export const UnstakeTabMobile = () => {
  ...
  return (
    ...
    <div className="w-[100%] h-[100%] relative flex flex-col">
      ...
      <span className="absolute bottom-[2%] right-[3%] font-baloo font-bold text-[4vw] text-[#7F7F7F]">{lendActiveToggle === "UNSTAKE" ? "staked gibgt" : "balance"}: { walletInfoLoading ? loadingElement() : handleStakeBalance('UNSTAKE') }</span>
    </div>
  )
}