...
export const NewGHoneyTabMobile = () => {
  ...
  return (
    <div className="rounded-3xl border border-amber-800/40 bg-black/85 p-4 text-white shadow-[0_15px_35px_rgba(0,0,0,0.55)] space-y-4">
      ...
      <p className="font-amaticbold text-center text-HoneyYellow text-lg leading-tight">
        Please note; conversion of gHoney to HONEY is subject to available liquidity at the time of transaction.
      </p>
      <GhoneyButton />
      <p className="font-baloo text-center text-HoneyYellow text-[8px] leading-tight">
