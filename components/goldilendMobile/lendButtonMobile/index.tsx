  ...
  return (
    <>
      {allowanceButtons && (
        <div>
          <button
            className="absolute left-[23%] top-[50%] h-[8%] w-[23%] border-2 border-black bg-[#E7B941] font-amaticbold text-[5vw] focus:scale-110 focus:bg-[#4D0B24] focus:text-[#E7B941]"
          ...
          <button
            className="absolute left-[54%] top-[50%] h-[8%] w-[23%] border-2 border-black bg-[#E7B941] font-amaticbold text-[5vw] focus:scale-110 focus:bg-[#4D0B24] focus:text-[#E7B941]"
      ...
      {!allowanceButtons && (
        <ConnectButton.Custom>
          {({ account, chain, openChainModal, openConnectModal }) => {
            return (
              <button
                className="absolute left-[23%] top-[50%] flex h-[8%] w-[54%] items-center justify-center border-2 border-black bg-[#E7B941] font-amaticbold text-[9vw] focus:scale-110 focus:bg-[#4D0B24] focus:text-[#E7B941]"
                id="lend-button"
                onClick={() => {
                  const button = document.getElementById("lend-button");
