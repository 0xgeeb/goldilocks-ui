      ...
      }
      {
        ...
        <ConnectButton.Custom>
          {({
            ...
            return (
              <button
                className="absolute h-[8%] w-[36%] md:w-[26%] lg:w-[16.6%] top-[60%] lg:top-[54.8%] 2xl:top-[55%] left-[32%] md:left-[37%] lg:left-[41.6%] bg-[#E7B941] font-amaticbold text-[6vw] md:text-[4vw] lg:text-[3vw] xl:text-[1.9vw] border-2 border-black hover:bg-[#B35227] hover:text-[#E7B941] hover:scale-110"
                id="stake-button"
                onClick={() => {
                  const button = document.getElementById('stake-button')
