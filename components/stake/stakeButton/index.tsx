  ...
  return (
    <>
      {allowanceButtons && (
        <div>
          <button
            className="cursor-pointer absolute left-[24%] top-[60%] h-[8%] w-[24%] border-2 border-black bg-[#E7B941] font-amaticbold text-[4vw] hover:scale-110 hover:bg-[#B35227] hover:text-[#E7B941] md:text-[2.75vw] lg:left-[30.9%] lg:top-[54.8%] lg:w-[16.6%] lg:text-[2vw] xl:text-[1.5vw] 2xl:top-[55%]"
          ...
          <button
            className="cursor-pointer absolute left-[52%] top-[60%] h-[8%] w-[24%] border-2 border-black bg-[#E7B941] font-amaticbold text-[4vw] hover:scale-110 hover:bg-[#B35227] hover:text-[#E7B941] md:text-[2.75vw] lg:left-[52.5%] lg:top-[54.8%] lg:w-[16.6%] lg:text-[2vw] xl:text-[1.5vw] 2xl:top-[55%]"
      ...
      {!allowanceButtons && (
        <ConnectButton.Custom>
          {({ account, chain, openChainModal, openConnectModal }) => {
            return (
              <button
                className={`cursor-pointer absolute left-[32%] top-[60%] h-[8%] w-[36%] md:left-[37%] md:w-[26%] lg:left-[41.6%] lg:top-[54.8%] lg:w-[16.6%] 2xl:top-[55%] ${buttonLoadingColor ? "bg-[#B35227] text-[#E7B941]" : "bg-[#E7B941] text-black"} border-2 border-black font-amaticbold text-[5vw] hover:scale-110 hover:bg-[#B35227] hover:text-[#E7B941] md:text-[4vw] lg:text-[3vw] xl:text-[2.25vw] 2xl:text-[1.9vw] tall:text-[6vw] tall:md:text-[4vw] tall:lg:text-[3vw] tall:xl:text-[2.5vw] tall:2xl:text-[1.9vw]`}
                id="stake-button"
                onClick={() => {
                  const button = document.getElementById("stake-button");
