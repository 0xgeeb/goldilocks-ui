  ...
  return (
    ...
    <main className="w-screen h-screen" onClick={() => handlePopups()}>
      ...
      <div className="w-[100%] h-[89%] lg:h-[85%] bg-cover bg-bottom bg-[url('/images/bg-goldiswap.png')] relative">
        ...
        <div className="absolute top-[13.22%] lg:top-[9.387%] left-[20%] lg:left-[28.125%] w-[60%] lg:w-[43.75%] h-[2.78%] bg-[#B35227] flex flex-row items-center justify-between px-2 text-[1.5vw] lg:text-[0.85vw]">
